...
export default function AdminAttendance() {
  ...
  // Modals are portaled to document.body so their position:fixed overlay
  // anchors to the viewport rather than the transformed .fade-in ancestor.
        ...
        {[
          ...
          <div key={item.label} style={{ display: "flex", alignItems: "center", flex: 1 }}>
            <div style={{ flex: 1 }}>
              ...
              {eventScopePending ? (
                <Loader2 className="animate-spin" size={20} color="var(--dimmed)" />
              ) : (
