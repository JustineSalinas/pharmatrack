...
function ForgotPasswordForm() {
  ...
  const linkExpired = searchParams.get("expired") === "true";
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          {linkExpired && (
            <div style={{
              ...
              color: "#E8B84B", textAlign: "center", fontSize: "0.85rem",
  ...
  return (
    <div className="page-wrapper">
      ...
      <div className="auth-page fade-in">
        <Suspense fallback={
          <div className="auth-card" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "200px" }} />
        }>
          <ForgotPasswordForm />
        </Suspense>
      </div>
