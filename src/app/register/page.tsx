          ...
          {registrationComplete ? (
            ...
            <>
              ...
              <form className="auth-form" onSubmit={handleRegister}>
                ...
                <button
                  type="submit"
                  className={`btn btn-gold pulse-btn w-full min-h-[48px] py-3.5 px-6 md:min-h-0 md:p-[16px] mt-5 md:mt-[10px] text-base font-semibold md:font-bold md:text-[1.1rem]`}
                  style={{ opacity: (!privacyAgreed || loading) ? 0.45 : 1, cursor: (!privacyAgreed || loading) ? "not-allowed" : "pointer", transition: "opacity 0.2s" }}
